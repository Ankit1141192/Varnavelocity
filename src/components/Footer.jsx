...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30">
        ...
        <div className="flex flex-col items-start gap-4 max-w-sm">
          ...
          <div className="flex gap-3 mt-1">
            ...
            {/* GitHub */}
            <a href="https://github.com/AnitBr17" aria-label="GitHub">
              <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/anit-baranwal/" aria-label="LinkedIn">
              <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
      ...
      <p className="py-6 text-center text-sm md:text-base text-gray-600 bg-gray-100 rounded-b-xl shadow-inner">
        © 2025 <a href="#" className="text-blue-600 font-medium hover:underline transition">Varnavelocity</a> —
        Made with ❤️ by <a href="#" className="text-purple-600 font-semibold hover:underline transition">Ankit Kumar</a> and <a href="#" className="text-purple-600 font-semibold hover:underline transition">Anit Baranwal</a>.
        All rights reserved.
      </p>
